...
function cleanNickname(name) {
    ...
    // Make sure this regex matches the exact status options defined in the SlashCommandBuilder.
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // Defer the reply immediately to give time for database and Discord API operations
        try {
            ...
            // If deferReply fails (e.g., interaction expired), we cannot reply or editReply later.
            // Just log and return to prevent further errors like InteractionNotReplied.
            return;
        }
